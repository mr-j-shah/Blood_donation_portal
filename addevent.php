...
<div
    ...
    <div class="mb-3">
    <label for="exampleInputName" class="form-label">Add Event</label>
    <input type="text" class="form-control" id="exampleInputName" name="add_event">
    </div>
    <div class="mb-3">
    <label for="exampleInputAddress" class="form-label">Event Address:</label>
    <textarea  rows="3" cols="7" class="form-control" id="address" name="address">    </textarea> 
  </div>
  <div class="mb-3">
    <label for="exampleInputDate" class="form-label">Date of Event:</label>
